			...
			try {
				if (loginMember == null) { // 로그인 X 화면
					...
					case 2: boardview.boardMenu();
						...
						break;
					case 0: loginMember=null; // loginMember가 참조하는 객체가 없음(==null)
							System.out.println("\n[로그아웃 되었습니다.]");
							input=-1; // do-while문이 종료되지 않도록 0이 아닌 값으로 변경
						break;
					case 99: System.out.println("프로그램 종료"); 
//							 input=0; // do-while조건을 false로 만듦
							 System.exit(0); // JVM을 종료시킨다, 매개변수는 0 아니면 오류
						break;
					default:
						System.out.println("메뉴에 작성된 번호만 입력해주세요.");
					}
