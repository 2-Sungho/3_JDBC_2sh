...
public class LoadXMLFile {
	...
	public static void main(String[] args) {
		...
		try {
			Properties prop=new Properties(); // Map<Key:Value>
			...
			/* 왜 XML파일을 이용해서 DB 연결 정보를 읽어와야 할까?
			 * 
			 * 1. 코드 중복 제거(주된 의미 X)
			 * 2. *별도 관리 용도 
			 * 	- 파일을 이용해서 수정이 용이함
			 ...
			 *      파일 내용만 수정하면 재컴파일은 수행되지 않는다)
			 * 4. XML 파일에 작성된 문자열 형태를 그대로 읽어오기 때문에 SQL 작성시 좀 더 편리해진다
			 */
